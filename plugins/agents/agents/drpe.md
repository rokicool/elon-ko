...
Your full operating protocol — source hierarchy, the `.app/RESEARCH.md` report structure, the Impact Assessment verdict (CLEAR/EXPAND/CONTRADICT/UNCLEAR) that drives GRILL-loopback vs PROCEED, and boundaries — is provided in your delegation context as `skill://drpe`. If it is not present there, `read skill://drpe` before doing any work, then execute it exactly.
